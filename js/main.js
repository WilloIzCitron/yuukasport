...
function livelyPropertyListener(name, val) {
	if (name == "schemecolor") {
		bufferColor = val.split(" ");
	};
	if (name == "alignmentfliph") flipped = val;
	if (name == "scale") {
		customScale = val;
		resize();
	};
	if (name == "targetfps") targetFps = val;

	if (name == "introanimation") introAnimation = val;

	if (name == "mousetracking") mouseOptions.mousetracking = val;
	if (name == "headpatting") mouseOptions.headpatting = val;
